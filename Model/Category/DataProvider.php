<?php
namespace Jnext\Megamenu\Model\Category;
        ...
        return [
            ...
            'megamenu' =>
                [
                    ...
                    'mega_menu_width',
                    'mega_category_label',
                    'mega_category_thumbnail_image',
                    'mega_display_top_block',
                    'mega_top_block_id',
                    'mega_top_block_content',
                    'mega_display_left_block',
                    'mega_left_block_id',
                    'mega_left_block_content',
                    'mega_left_block_width',
                    'mega_display_right_block',
                    'mega_right_block_id',
                    'mega_right_block_content',
                    'mega_right_block_width',
                    'mega_display_bottom_block',
                    'mega_bottom_block_id',
